...
\newcommand{\FigDAG}{
  \begin{figure}
    ...
    \caption{\textbf{Graphical Causal Model of vaccine efficacy.} Directed acyclic graph representing validated causal relationships expressed by the SCM \(\mathbb{C}_{VE}\) (Model~\ref{eq:SCM}). Covariates and potential confounders (blue nodes) were parasite infection (presence or burden) \(P\), reproductive status \(R\), body mass \(M\), fat scores \(F\), and sex \(S\). }
    \label{fig:DAG}
  \end{figure}
}
