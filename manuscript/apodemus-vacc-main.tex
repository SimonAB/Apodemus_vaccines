...
\title{Causes of variation in vaccine efficacy in a natural rodent population}

% Use letters for affiliations, numbers to show equal authorship (if applicable) and to indicate the corresponding author
\author[a]{Saudamini Venkatesan}
\author[b]{Ewan Smith}
\author[a,1]{Amy B. Pedersen}
\author[b,1,2]{Simon A. Babayan}
...
\equalauthors{\textsuperscript{1}ABP contributed equally to this work with SAB.}
\correspondingauthor{\textsuperscript{2}To whom correspondence should be addressed. E-mail: simon.babayan\@glasgow.ac.uk}
...
% Bibliography
\bibliography{apodemus-vacc-refs}
