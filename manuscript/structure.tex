...
\newcommand{\authordetailsblock}{
	...
	\parbox[t]{0.6\textwidth}{ % Box holding the author details; width value specifies where it starts and ends, increase to move details left
...
\address{
	...
	\hspace{0.9\textwidth} % Position of the institution logo, increase to move left, decrease to move right
	\vskip -0.105\textheight~\\ % Position of the large header text in relation to the institution logo, increase to move down, decrease to move up
	\huge\hspace{0.12\textwidth}\headerlineone\hfill ~\\[0.005\textheight] % First line of institution name, adjust hspace if your logo is wide and adjust space between header lines with textheight
	\hspace{0.12\textwidth}\headerlinetwo\hfill \normalsize % Second line of institution name, adjust hspace if your logo is wide
	\makebox[0ex][r]{\textbf{\Who\Title}}\hspace{0.0001\textwidth} % Print author name and title with a little whitespace to the right
	~\\[-0.007\textheight] % Reduce the whitespace above the horizontal rule
	\hspace{0.12\textwidth}\vhrulefill{1pt} \\ % Horizontal rule, adjust hspace if your logo is wide and \vhrulefill for the thickness of the rule
...
\renewcommand{\closing}[1]{
	\vspace{10mm} % Some whitespace after the letter content and before the signature
	\noindent % Stop paragraph indentation
	% \hspace*{\fill} % Move the signature right to the value of \longindentation or \fill
	\parbox{1.2\indentedwidth}{
		\raggedright
		#1 % Print the signature text
		\includegraphics[width=7cm]{~/Documents/Work/Admin/Signature-transp.pdf} % Include the author's signature
		\vskip -0.4cm % Whitespace between the closing text and author's name for a physical signature
