...
\end{tikzpicture}
\vspace{1cm}
\begin{tikzpicture}[scale=0.75, inner sep=0pt, xshift=-1cm] % Added xshift
  ...
  \draw [-stealth] (D) edge (F);
  \draw [-stealth] (D) edge (M);
  \draw [-stealth, dashed, gray] (D) edge (P); % Modified edge
  \draw [-stealth] (D) edge (R);
  \draw [-stealth] (F) edge (E);
  \draw [-stealth] (F) edge (M);
  \draw [-stealth] (M) edge (E);
  ...
  \draw [-stealth] (R) .. controls (0.7, 2.2) .. (F);
  \draw [-stealth] (R) edge (M);
  \draw [-stealth, dashed, gray] (R) edge (P); % Modified edge
  \draw [-stealth] (S) edge (E);
  \draw [-stealth] (S) edge (F);
  \draw [-stealth] (S) edge (M);
  \draw [-stealth, dashed, gray] (S) edge (P); % Modified edge
  \draw [-stealth] (S) edge (R);
  \draw [-stealth] (V) edge (E);
  \draw [-stealth] (V) edge (F);
  \draw [-stealth] (V) edge (M);
  \draw [-stealth] (V) edge (R);
  \draw [-stealth, dashed, gray] (V) edge (P); % Modified edge
  \draw [-stealth] (V) edge (E);
  % \draw [-stealth] (H) edge (D);
  \draw [-stealth] (H) .. controls (0, 0.4) .. (E);
  \draw [-stealth] (H) edge (F);
  \draw [-stealth] (H) edge (M);
  \draw [-stealth, dashed, gray] (H) edge (P); % Modified edge
  \draw [-stealth] (H) edge (R);
\end{tikzpicture}
\hfill
\begin{tikzpicture}
  ...
  \node [mybox, right =of E] (box){%
    \begin{minipage}[!t]{0.63\textwidth}
      \begin{equation} \label{eq:SCM_post}
        \footnotesize
        \openup -0.5ex % affecting the line spacing in the environment
        \begin{split}
          V & \coloneq \mathcal{U}_V                                                                                     \\
