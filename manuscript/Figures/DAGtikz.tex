...
\begin{tikzpicture}[scale=0.75, inner sep=0pt]
  ...
  \node[circle, draw, fill=Cyan, text opacity=1, fill opacity=0.4, minimum width=16pt] (T) at (-1.6,0.4) {\(T\)};
  \node[circle, draw, fill=LimeGreen, text opacity=1, fill opacity=0.4, minimum width=16pt] (H) at (-2.6,1) {\(H\)};
  \node[circle, draw, fill=LimeGreen, text opacity=1, fill opacity=0.4, minimum width=16pt] (D) at (-2.2,2.7) {\(D\)};
  ...
  \node[circle, draw, fill=Cyan, text opacity=1, fill opacity=0.4, minimum width=16pt] (S) at (2.2,2.7) {\(S\)};
