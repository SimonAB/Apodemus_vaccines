    ...
    \begin{tikzpicture}
      ...
      \node [mybox, right =of E] (box){%
        \begin{minipage}[!t]{\textwidth}
          ...
          R &\coloneq f(V, H, D, S, \mathcal{U}_R) \\
          P &\coloneq g(V, H, D, S, R, \mathcal{U}_P) \\
          F &\coloneq h(V, H, D, S, P, R, \mathcal{U}_F) \\
          M &\coloneq i(V, H, D, S, P, R, F, \mathcal{U}_M) \\
          E &\coloneq j(V, H, D, S, P, R, M, F, \mathcal{U}_E) \\
          \end{aligned}
          \end{equation}
        \end{minipage}
      };
    ...
    \begin{tikzpicture}
      ...
      \node [mybox, right =of E] (box){%
        \begin{minipage}[!t]{\textwidth}
          \footnotesize
          \openup -0.5ex
          \begin{equation} \label{eq:SCMcounterfactual}
            \begin{aligned}
          P & = 0 \\
          V & \coloneq \mathcal{U}_V \\
          H & \coloneq \mathcal{U}_H \\
