...
\begin{tikzpicture}[scale=0.75, inner sep=0pt]
  \node[inner sep = 0, font=\sffamily] (panel A) at (-3,5.3) {\textbf{A}};
  ...
  \node[circle, draw, fill=LimeGreen, text opacity=1, fill opacity=0.4, minimum width=16pt] (H) at (-2.8,1.5) {\(H\)};
...
\begin{tikzpicture}
  \node[inner sep = 0, font=\sffamily] (panel B) at (3.5,2.2) {\textbf{B}};
